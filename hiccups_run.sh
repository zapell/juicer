...
#SBATCH --output=output/hiccups_gpu_%j.out
#SBATCH --error=error/hiccups_gpu_%j.err
...
-t 0.02,1.5,1.75,2 \
-d 20000,20000,50000 \
 $OUTPUT_DIR/inter_30.hic $OUTPUT_DIR/hiccups_output_gpu